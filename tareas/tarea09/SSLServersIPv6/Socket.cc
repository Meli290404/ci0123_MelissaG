...
/**
  ...
  *  solo "envolvemos" el descriptor que ya existe en un objeto Socket
...
/**
  ...
  *  Con ese id creamos un Socket nuevo, pasandole this->IPv6 para que sepa
  *  si es un socket IPv4 o IPv6 (antes esto no se propagaba y siempre
  *  quedaba en IPv4, lo cual rompia un servidor IPv6). Ese objeto "peer"
  *  es con el que de ahi en adelante hablamos con ESE cliente en particular
  *  (Read/Write), mientras el socket original (this) se queda libre para
  *  seguir escuchando.
  *
 **/
